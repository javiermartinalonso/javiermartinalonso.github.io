...
A efectos de demostración durante el post, vamos a añadir en un controlador [REST Spring MVC](https://spring.io/guides/gs/rest-service/ "REST Spring MVC") que responda el típico ***"hola mundo!!!!"***.
